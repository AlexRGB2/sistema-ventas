...
class Utils {
     ...
     */
    generateJWT(payload) {
        let token = jsonwebtoken_1.default.sign(payload, keys_1.default.secret.jwt, { expiresIn: '1h' });
        return token;
    }
    /**
     * @name getPayload
     ...
     */
    getPayload(token) {
        let payload = jsonwebtoken_1.default.verify(token, keys_1.default.secret.jwt);
